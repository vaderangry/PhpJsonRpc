...
class ServerTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function generalRequestsProvider()
    {
        return [
            ...
            [
                '{"jsonrpc": "2.0", "method": "JsonRpc.HandlerExampleAlpha.add", "params": [16, 32], "id": 1}',
                '{"jsonrpc":"2.0","result":48,"id":1}'
            ],
            // #1 Rpc call with named parameters
            [
                '{"jsonrpc": "2.0", "method": "JsonRpc.HandlerExampleAlpha.add", "params": {"lhs": 2, "rhs": 16}, "id": 10}',
                '{"jsonrpc":"2.0","result":18,"id":10}'
            ],
            // #2
            [
                '{"jsonrpc": "2.0", "method": "JsonRpc.HandlerExampleAlpha.multiply", "params": {"lhs": 2, "rhs": 2}, "id": 20}',
                '{"jsonrpc":"2.0","result":4,"id":20}'
            ],
            // #3 Rpc call with invalid parameters (invalid params)
            [
                '{"jsonrpc": "2.0", "method": "JsonRpc.HandlerExampleAlpha.add", "params": {"lhs": 2, "rhs": "bad"}, "id": 30}',
            ...
            [
                '{"jsonrpc": "2.0", "method": "JsonRpc.HandlerExampleAlpha.add", "params": {"lhs": 2, "rhs": 3}, "id}',
            ...
            [
                '{"jsonrpc": "2.0", "method": "JsonRpc.TestBetaHandler.add", "params": {"lhs": 2, "rhs": 3}, "id": 50}',
            ...
            [
                '{"jsonrpc": "2.0", "method": "JsonRpc.HandlerExampleAlpha.division", "params": {"lhs": 2, "rhs": 16}, "id": 60}',
                '{"jsonrpc":"2.0","error":{"code":-32601,"message":"Method not found","data":{"code":0,"message":""}},"id":null}'
            ],
            ...
            // #8 Notification
            [
                '{"jsonrpc": "2.0", "method": "JsonRpc.HandlerExampleAlpha.add", "params": [18,18]}',
                ''
            ],
            // #9 Rpc call with server error (server error)
            [
                '{"jsonrpc": "2.0", "method": "JsonRpc.HandlerExampleAlpha.error", "params": [], "id": 90}',
                '{"jsonrpc":"2.0","error":{"code":-32000,"message":"Server Error","data":{"code":999,"message":"Internal error"}},"id":null}'
            ],
            // #10 Batch request
            [
                '[' .
                    '{"jsonrpc": "2.0", "method": "JsonRpc.HandlerExampleAlpha.add", "params": [1,2], "id": "101"},' .
                    '{"jsonrpc": "2.0", "method": "JsonRpc.HandlerExampleOmega.pow", "params": [7,3], "id": "102"},' .
                    '{"jsonrpc": "2.0", "method": "JsonRpc.HandlerExampleAlpha.multiply", "params": [42,23]},' .
                    '{"foo": "boo"},' .
                    '{"jsonrpc": "2.0", "method": "JsonRpc.HandlerExampleOmega.pow", "params": {"base": 3, "exp": 7}, "id": "105"},' .
                    '{"jsonrpc": "2.0", "method": "JsonRpc.HandlerExampleAlpha.error", "id": "106"}' .
                ']',
                '[' .
            ...
            [
                '[' .
                    '{"jsonrpc": "2.0", "method": "JsonRpc.HandlerExampleAlpha.add", "params": [1,2]},' .
